...
class MBFFuturePlanning(smach.StateMachine):
    ...
    def __init__(self):
        ...
        smach.StateMachine.__init__(self, input_keys=['target_pose'] ,outcomes=['succeeded', 'preempted', 'aborted'])
        ...
        with self:
            ...
            smach.StateMachine.add(
                ...
                transitions={
                    'failure': 'RECOVERY',
                    'succeeded': 'succeeded'}) # WAIT_FOR_GOAL
